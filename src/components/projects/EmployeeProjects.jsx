...
const EmployeeProjects = ({ onProjectClick }) => {
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            {/* Tabs Row (Assigned Projects only as per screenshot) */}
            <div className="flex gap-4 mb-4">
                <button
                    className="px-4 py-2 text-sm font-medium rounded-lg transition-colors border border-gray-200 text-gray-500 hover:bg-gray-50"
                >
                    Assigned Projects
                </button>
            </div>
                                ...
                                >
                                    ...
                                    <td className={styles.tableCell}>
                                        <div className="flex items-center gap-3 text-gray-400">
                                            ...
                                            <span className="hover:text-red-500 transition-colors cursor-pointer" onClick={(e) => e.stopPropagation()}>
                                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                </svg>
                                            </span>
                                            <span className="hover:text-indigo-600 transition-colors cursor-pointer" onClick={(e) => e.stopPropagation()}>
                                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
